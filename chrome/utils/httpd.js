...
var DEBUG = false; // non-var *only* so tweakable in server tests

/** True if debugging output should be timestamped. */
var DEBUG_TIMESTAMP = false; // non-var so tweakable in server tests
...
/* These two are non-var only so a test can overwrite them. */
