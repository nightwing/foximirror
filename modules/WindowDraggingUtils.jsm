...
let EXPORTED_SYMBOLS = [ "WindowDraggingElement2" ];

function WindowDraggingElement2(elem, window) {
  this._elem = elem;
  this._window = window;
  this._elem.addEventListener("mousedown", this, false);
}

WindowDraggingElement2.prototype = {
  ...
  dragTags: ["box", "hbox", "vbox", "spacer", "label", "statusbarpanel", "stack",
             ...
             "radiogroup", "deck", "scrollbox","toolbar","statusbar","findbar"],
